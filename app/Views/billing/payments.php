...
<div class="container mx-auto px-4 py-8">
    <div class="max-w-6xl mx-auto">
        ...
        <div class="flex justify-between items-center mb-8">
            ...
            <a href="/billing/invoices" class="text-blue-600 hover:text-blue-800">View Invoices</a>
        </div>
                            ...
                            <?php foreach ($payments as $payment): ?>
                                <tr class="hover:bg-gray-50">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="text-sm font-medium text-gray-900"><?= htmlspecialchars($payment['invoice_number']) ?></div>
                                        <div class="text-sm text-gray-500"><?= htmlspecialchars($payment['transaction_id']) ?></div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="text-sm font-medium text-gray-900"><?= htmlspecialchars($payment['shop_name']) ?></div>
                                        <div class="text-sm text-gray-500"><?= htmlspecialchars($payment['business_name']) ?></div>
                                    </td>
